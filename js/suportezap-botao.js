...
const bottomOffset = siteData.bottomOffset || 20;
const sideOffset = siteData.sideOffset || 20;
...
.atendezap-widget.right { right: ${sideOffset}px; }
.atendezap-widget.left { left: ${sideOffset}px; }
@keyframes tada {
0% {
